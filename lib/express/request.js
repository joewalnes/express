...
exports.Request = new Class({
  ...
  content: function(content_type, callback) {
    if(!this.contentTypeCallbacks) this.contentTypeCallbacks = {};
    this.contentTypeCallbacks[mime.type(content_type)] = callback;
  },

  contentCallback: function() {
    if(this.hasContentTypeCallbacks)
      return this.contentTypeCallbacks[this.header('Content-Type')];
  },

  hasContentTypeCallbacks: function() {
    return this.contentTypeCallbacks
  },
